      ...
      <div className='flex flex-wrap gap-4'>
        <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all duration-300'>
          ...
          <div>
            ...
            <p className='text-gray-400 font-light pr-8'>Blogs</p>
          </div>
        </div>
        ...
        <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all duration-300'>
          ...
          <div>
            ...
            <p className='text-gray-400 font-light pr-8'>Comments</p>
          </div>
        </div>
        ...
        <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all duration-300'>
          ...
          <div>
            ...
            <p className='text-gray-400 font-light pr-8'>Drafts</p>
          </div>
        </div>
      </div>
